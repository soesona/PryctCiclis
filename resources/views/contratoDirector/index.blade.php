...
<html lang="en">
  <head>
    ...
    <title>Contratos de {{ $director->nombre }} {{ $director->apellido }}</title>
  ...
  <body class="pt-8">
    ...
    <div class="container mx-auto px-4">
      ...
      Contratos de {{ $director->nombre }} {{ $director->apellido }}
      </h1>
              ...
              @empty
                <tr>
                  <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                    No hay contratos para este director.
                  </td>
                </tr>
              @endforelse
            </tbody>
    ...
    <div class="modal" id="mCrearContrato" tabindex="-1" aria-labelledby="crearContratoLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <form id="formCrearContrato" action="{{ route('contratoDirectores.store') }}" method="POST">
            @csrf
            <input type="hidden" name="codigoDirector" value="{{ $director->codigoDirector }}">
    ...
    <script>
      ...
      editarModal.addEventListener('show.bs.modal', event => {
        ...
        form.action = `/contratoDirectores/${idContrato}`;
